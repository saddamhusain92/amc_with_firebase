...
import { auth, teamcollectionRef } from "../../firebase/config"
...
const navigation = [
  ...
  { name: 'KYC', href: 'kyc', icon: FolderIcon, current: false },
]
                            ...
                            {navigation.map((item) => (
                              <li key={item.name}>
                                <NavLink
                                  ...
                                  to={path!=="/profile"?item.href:"/profile"}
        ...
        <div className="lg:pl-72">
                ...
                <div className="flex items-center gap-x-4 lg:gap-x-6">
                  ...
                  <Menu as="div" className="relative">
                    <Menu.Button className="-m-1.5 flex items-center p-1.5">
                      ...
                      <ArrowRightCircleIcon onClick={logout} className="ml-2 h-5 w-5 text-rose-400" aria-hidden="true" />
          ...
          <main className="py-10">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              {path!=="/profile"?<Outlet/>:<UserProfile/>}
